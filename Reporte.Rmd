...
make2 <- datos$cole_nombre_sede[datos$cole_cod_dane_sede == params$codigo][1]
make <- as.character(make2[1])
...
if  ( (nrow(materia[materia$grupo== "1.Colegio" & materia$genero == "M",]) > 5) &
 (nrow(materia[materia$grupo== "1.Colegio" & materia$genero == "F",]) > 5) ) {
