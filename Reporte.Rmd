...
numero <- unique(datos$cole_cod_dane_sede)[params$codigo]

make <- datos$cole_nombre_sede[datos$cole_cod_dane_sede == format(unique(datos$cole_cod_dane_sede)[params$codigo],scientific = FALSE)[1]]
